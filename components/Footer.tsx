      ...
      <div className={styles.container}>
        ...
        <div className={styles.socialSection}>
          ...
          <div className={styles.socialLinks}>
            <a 
              href="https://www.facebook.com/ColoradoCareAssist" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href="https://www.instagram.com/coloradocareassist" 
              target="_blank" 
              rel="noopener noreferrer"
              className={styles.socialLink}
            ...
            <a 
              href="https://www.youtube.com/@ColoradoCareAssist" 
              target="_blank" 
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="YouTube"
            ...
            <a 
              href="https://www.pinterest.com/coloradocareassist" 
              target="_blank" 
              rel="noopener noreferrer"
              className={styles.socialLink}
            ...
            <a 
              href="https://www.tiktok.com/@coloradocareassist" 
              target="_blank" 
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="TikTok"
